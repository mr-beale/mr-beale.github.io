...
function toggleMenu() {
    ...
    if (document.querySelector(".toggle").textContent == "☰ Menu") {
        document.querySelector(".toggle").textContent = "X";
    } else if (document.querySelector(".toggle").textContent == "X") {
        document.querySelector(".toggle").textContent = "☰ Menu";
    }
};
